...
@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Crear Un Nuevo Expositor</li>
        </ol>
    </nav>
@stop
    ...
    <div class="col-md-5">
        <div class="card card-primary">
            ...
            <div class="card-body" style="display: block;">
                <form action="{{ url('/admin/Expositores/create') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="biografia" name="biografia" rows="5"
                                    placeholder="Ingrese la biografía del expositor" required></textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
