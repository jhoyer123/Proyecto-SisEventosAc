                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tipo_evento" name="tipo_evento" required>
                                    ...
                                    <option value="conferencia" {{ old('tipo_evento') == 'conferencia' ? 'selected' : '' }}>
                                        Conferencia</option>
                                    <option value="taller" {{ old('tipo_evento') == 'taller' ? 'selected' : '' }}>Taller
                                    </option>
                                    <option value="seminario" {{ old('tipo_evento') == 'seminario' ? 'selected' : '' }}>
                                        Seminario</option>
                                    <option value="webinar" {{ old('tipo_evento') == 'webinar' ? 'selected' : '' }}>Webinar
                                    </option>
                                    <option value="otro" {{ old('tipo_evento') == 'otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                            </div>
                            @error('tipo_evento')
                                <small style="color: red">{{ $message }}</small>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ubicacion" name="ubicacion"
                                    placeholder="Ingrese la dirección donde se realizara el evento" required>
                            </div>
                            @error('ubicacion')
                                <small style="color: red">{{ $message }}</small>
                            @enderror
