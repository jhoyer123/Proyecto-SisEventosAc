...
@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/admin/Users') }}">Inscritos</a></li>
            <li class="breadcrumb-item active" aria-current="page">Usuarios con almenos una inscripción</li>
        </ol>
    </nav>
@stop
    ...
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h3 class="card-title">Inscripciones Registradas En El Sistema</h3>
                    ...
                    <tbody>
                        @foreach ($reporte as $report)
                            <tr>
                                ...
                                <td>{{ $report->nombre_participante }}</td>
                                <td>{{ $report->correo }}</td>
                                <td>{{ $report->nombre_evento }}</td>
